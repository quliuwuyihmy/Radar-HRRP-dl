...
[hrrp_batch,labels_batch] = get_train_batch(train_hrrp,train_labels,batch_size = train_batch_size)
...
[hrrp_test,labels_test] = get_train_batch(test_hrrp,test_labels,batch_size = test_batch_size)
